...
\begin{abstract}
    ...
    It turns out that an (even imagined) limit in the perceivable worldview is not beneficial to scientific research. % and in no way can science ever fully replace religion
\end{abstract}
