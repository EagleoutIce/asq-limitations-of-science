...
\begin{abstract}
    ...
    It turns out that an (even imagined) limit in the perceivable worldview is not beneficial to scientific research. Also, the integration of religion into science even seems to be favorable.
