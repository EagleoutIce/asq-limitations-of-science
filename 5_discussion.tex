...
This perspective differs from that of the \say{The Matrix}-Trilogy\footurl{https://www.imdb.com/title/tt0133093/}{2021-03-17} where the in-game state differs from the out-game state in its rules.
It further differs from Abbott's \say{Flatland}~\cite{abbott1987flatland} where the out-game state \emph{created} the in-game state (furthermore, in Abbot's story they do casually interact with each other).
